...
- (double)trackTime
{
	return [output framesToSeconds:bufferChain.framesCount];
}
...
{    
    [delegate audioPlayer:self willEndStream:userInfo];
...
{
    [delegate audioPlayer:self didBeginStream:userInfo];
